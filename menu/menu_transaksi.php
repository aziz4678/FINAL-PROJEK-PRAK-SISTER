        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Data Transaksi</h2>
                </div>
            </nav>
                ...
                <table class="table table-light table-striped rounded table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Nominal Diamond</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $r->metode; ?></td>
                                <td>
                                    <form action="menu_edit_transaksi.php?id_transaksi=<?php echo $r->id_transaksi ?>" method="post">
                                        <input class="btn btn-success btn-sm" type="submit" value="edit">
                                    </form>
                                    <p></p>
                                    <form action="../client/proses_transaksi.php?aksi=hapus&id_transaksi=<?php echo $r->id_transaksi ?>" method="post">
                                        <input class="btn btn-danger btn-sm" type="submit" name="hapus" value="hapus" onClick="return confirm('Apakah Anda ingin menghapus data transaksi?')">
                                    </form>
                                </td>
                            </tr>
                        <?php
